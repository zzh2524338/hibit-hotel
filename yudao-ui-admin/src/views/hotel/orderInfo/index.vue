  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="预定人" prop="orderGuestName">
        <el-input v-model="queryParams.orderGuestName" placeholder="请输入预定人z电话" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="联系人" prop="contactPerson">
        <el-input v-model="queryParams.contactPerson" placeholder="请输入联系人" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="联系电话" prop="contactNumber">
        <el-input v-model="queryParams.contactNumber" placeholder="请输入联系电话" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="房间信息" prop="roomInfo">
        <el-input v-model="queryParams.roomInfo" placeholder="请输入房间信息" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="会员信息快照" prop="memberInfo">
        <el-input v-model="queryParams.memberInfo" placeholder="请输入会员信息快照" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="订单来源" prop="guestSourceId">
        <el-input v-model="queryParams.guestSourceId" placeholder="请输入订单来源" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="入住时间" prop="checkInTime">
        <el-date-picker clearable v-model="queryParams.checkInTime" type="date" value-format="yyyy-MM-dd" placeholder="选择入住时间" />
      </el-form-item>
      <el-form-item label="离店时间" prop="checkOutTime">
        <el-date-picker clearable v-model="queryParams.checkOutTime" type="date" value-format="yyyy-MM-dd" placeholder="选择离店时间" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   v-hasPermi="['hotel:order-info:create']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" :loading="exportLoading"
                   v-hasPermi="['hotel:order-info:export']">导出</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['hotel:order-info:update']">修改</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['hotel:order-info:delete']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="预定人名称" prop="orderGuestName">
          <el-input v-model="form.orderGuestName" placeholder="请输入预定人名称" />
        </el-form-item>
        <el-form-item label="联系人" prop="contactPerson">
        ...
        <el-form-item label="入住时间" prop="checkInTime">
          <el-date-picker clearable v-model="form.checkInTime" type="date" value-format="timestamp" placeholder="选择入住时间" />
        </el-form-item>
        <el-form-item label="客人信息" prop="guestInfo">
          <el-input v-model="form.guestInfo" placeholder="请输入客人信息" />
        </el-form-item>
        <el-form-item label="离店时间" prop="checkOutTime">
          <el-date-picker clearable v-model="form.checkOutTime" type="date" value-format="timestamp" placeholder="选择离店时间" />
        </el-form-item>
      </el-form>
...
<script>
import { createOrderInfo, updateOrderInfo, deleteOrderInfo, getOrderInfo, getOrderInfoPage, exportOrderInfoExcel } from "@/api/hotel/orderInfo";
